...
class HippocampusDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        )  # Add channel dim, ensure float32
...
def get_train_val_dataloaders(
    data_dir, batch_size=2, val_split=0.2, target_shape=(32, 48, 32), num_workers=0
):
    """
...
if __name__ == "__main__":
    ...
    train_loader, val_loader = get_train_val_dataloaders(
        data_dir=data_dir, batch_size=2, val_split=0.2, target_shape=(32, 48, 32)
    )
