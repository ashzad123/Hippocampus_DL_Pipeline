...
if __name__ == "__main__":
    ...
    print("\n" + "=" * 70)
    print("✓ Data exploration complete! You can check the visualizations in the 'results/visualizations' folder.")
    print("Next we will be running the testing pipeline:")
    print("=" * 70)
